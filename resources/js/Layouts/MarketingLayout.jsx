...
const navigation = [
    ...
    { name: 'Vue Website', href: 'https://vue.jacobhenning.app' },
    { name: 'My Website', href: 'https://jacobhenning.com' },
]

export default function MarketingLayout({ user, header, children }) {
                ...
                <header className="absolute z-20 w-full">
                    <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                        <div className="flex lg:flex-1">
                            <a href="/"
                               className="flex items-center font-black bg-sky-600 px-3 py-4 text-right text-gray-50 -mt-8 shadow">
                                Laravel<br />React
                            </a>
                        </div>
